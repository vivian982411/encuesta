...
function mostrarVistaDepartamento(id,nombredep){
	var titulo="";
	if (id=="1") {
		titulo="Centro de Información";
	}else if(id=="2"){
		titulo="Coordinación de Carreras";
	}else if(id=="3"){
		titulo="Recursos Financieros";
	}else if(id=="4"){
		titulo="Resisdencias Profesionales";
	}else if(id=="5"){
	...
	.done(function(info) {
		...
		var btn1= document.createElement("input");
			...
			btn1.setAttribute("onclick","javascript:nuevaPregunta('"+id+"','"+nombredep+"');");
...
function nuevaPregunta(id,nombredep){
	$.ajax({
		url: 'php/vistas.php',
		type: 'POST',
		dataType: 'html',
...
function showDepartamentos() {
	...
	var div1=document.createElement("div");
		div1.setAttribute("class","btn btn-primary m-1 animated bounceInDown");
		div1.setAttribute("style","width:125px; height:60px;");
		div1.setAttribute("onclick","generarXLS('1');")
		div1.innerHTML="Centro de Información";
	var div2=document.createElement("div");
		div2.setAttribute("class","btn btn-secondary m-1 animated bounceInUp");
		div2.setAttribute("style","width:125px; height:60px");
		div2.setAttribute("onclick","generarXLS('2');")
		div2.innerHTML="Coordinación de Carreras";
	var div3=document.createElement("div");
		div3.setAttribute("class","btn btn-info m-1 animated bounceInDown");
		div3.setAttribute("style","width:125px; height:60px;");
		div3.setAttribute("onclick","generarXLS('3');")
		div3.innerHTML="Recursos Financieros";
	var div4=document.createElement("div");
		div4.setAttribute("class","btn btn-success m-1 animated bounceInUp");
		div4.setAttribute("style","width:125px; height:60px;");
		div4.setAttribute("onclick","generarXLS('4');")
		div4.innerHTML="Residencias Profesionales";
	var div5=document.createElement("div");
		div5.setAttribute("class","btn btn-warning m-1 animated bounceInDown");
		div5.setAttribute("style","width:125px; height:60px;");
		div5.setAttribute("onclick","generarXLS('5');")
		div5.innerHTML="Centro de Cómputo";
	var div6=document.createElement("div");
		div6.setAttribute("class","btn btn-danger m-1 animated bounceInUp");
		div6.setAttribute("style","width:125px; height:60px;");
		div6.setAttribute("onclick","generarXLS('6');")
		div6.innerHTML="Servicios Escolares";
	var div7=document.createElement("div");
		div7.setAttribute("class","btn btn-dark m-1 animated bounceInDown");
		div7.setAttribute("style","width:125px; height:60px;");
		div7.setAttribute("onclick","generarXLS('7');")
		div7.innerHTML="Servicio Social";
	document.getElementById("containerDepartamentos").appendChild(div1);
	document.getElementById("containerDepartamentos").appendChild(div2);
	document.getElementById("containerDepartamentos").appendChild(div3);
	document.getElementById("containerDepartamentos").appendChild(div4);
	document.getElementById("containerDepartamentos").appendChild(div5);
	document.getElementById("containerDepartamentos").appendChild(div6);
	document.getElementById("containerDepartamentos").appendChild(div7);
}
function generarXLS(id) {
	var nombre="";
	console.log(id);
	if (id==1) {
		nombre="CentroDeInformacion";
	}else if(id==2){
		nombre="CoordinacionDeCarreras";
	}else if(id==3){
		nombre="RecursosFinancieros";
	}else if(id==4){
		nombre="ResidenciasProfesionales";
	}else if(id==5){
		nombre="CentroDeComputo";
	}else if(id==6){
		nombre="ServiciosEscolares";
	}else if(id==7){
		nombre="ServicioSocial";
	}else if(id==8){
		nombre="General";
	}
	$.ajax({
